...
def getInfo(sym):
    ...
    stockGrades.append([sym, (getGrade(valuationStats) * 1.20 + getGrade(profitabilityStats) + (getGrade(growthStats) * 1.10) + getGrade(perfStats)) / 4, marketCap, companyDescription, valuationStats, profitabilityStats, growthStats, perfStats])

    print('Overall Rating:', (getGrade(valuationStats) * 1.20 + getGrade(profitabilityStats) + (getGrade(growthStats) * 1.10) + getGrade(perfStats)) / 4)
